...
6. [`The synthetic data file we used for development and testing`](https://github.com/AI-DataScientist-UBC/AI-DataScientist-Interface/blob/main/Synthetic.csv)
